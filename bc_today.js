"use strict"; //Interprets Javascript code strictly
/*
...
*/
var thisDate = new Date(); //Took out date to reflect current date
var dateString = thisDate.toLocaleDateString(); //Puts date in local convention format

var dateHTML = "<h2>" + dateString + "</h2>"; //Puts date in size 2 header
var thisDay = thisDate.getDay();

var eventHTML = getEvent(thisDay);

document.getElementById("unionToday").insertAdjacentHTML("beforeEnd", dateHTML + eventHTML); //What users see on website
